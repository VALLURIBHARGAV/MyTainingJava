...
<body>
   ...
   <% int value=(int)request.getAttribute("bedid"); %>
   <form:form modelAttribute="bed" action="/editBed" method="post">
    <form:label path="bedno">Bed Number:</form:label>
    <form:input type="number" path="bedno" id="bedno" /><br>
    ...
    <form:label path="ward">Location:</form:label>
    <form:select path="ward" id="ward">
        <option value="ICU">ICU</option>
        <option value="General">General</option>
        <option value="Ward">Ward</option>
    </form:select><br>
    <form:input path="bedid" value="<%=value%>" type="hidden"/>
