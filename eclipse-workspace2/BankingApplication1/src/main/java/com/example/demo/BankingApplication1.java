...
public class BankingApplication1 {
	...
	public static void main(String[] args) {
		SpringApplication.run(BankingApplication1.class, args);
	}
		@Bean
        CommandLineRunner demo(UserRepository userRespository , AccountRespository accountRespository){
			return(args)->{
	                ...
	                while (true) {
	                    ...
	                    if (option == 1) {
	                       ...
	                       // bs.getBalance(currentUserId);
	                        ...
	                        loggedIn = false;
	                        currentUserId = null;
	                        System.out.println("Not Logged In!, Login to Access the Banking Services");
	                        break;
	                    }
	                }
	            }
